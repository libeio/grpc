...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/grpc/lib/libz.so.1.2.11;/usr/local/grpc/lib/libz.so.1")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/local/grpc/lib/libz.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/grpc/lib/libz.so")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/grpc/lib/libz.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/grpc/lib/libz.so")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/usr/local/grpc/lib" TYPE SHARED_LIBRARY FILES "/home/gitfork/grpc/build/third_party/zlib/libz.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/grpc/lib/libz.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/grpc/lib/libz.so")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/grpc/lib/libz.so")
    endif()
  endif()
endif()
